          ...
          <div className="space-y-4 w-3/4 mx-auto">
            ...
            <details className="w-full border rounded-lg">
              ...
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">
                ...
                JWT defines the structure of information we are sending from one
                party to the another, and it comes in two forms – Serialized,
                Deserialized. The Serialized approach is mainly used to transfer
                the data through the network with each request and response.
                While the deserialized approach is used to read and write data
                to the web token. <br />A header in a JWT is mostly used to
                describe the cryptographic operations applied to the JWT like
                signing/decryption technique used on it. It can also contain the
                data about the media/content type of the information we are
                sending.This information is present as a JSON object then this
                JSON object is encoded to BASE64URL. The cryptographic
                operations in the header define whether the JWT is
            ...
            <details className="w-full border rounded-lg">
              ...
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">
                ...
                programming to be more helpful. <br /> <br />
